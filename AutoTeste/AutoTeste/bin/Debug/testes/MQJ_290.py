...
<meta id="atlassian-token" name="atlassian-token" content="BUQO-ZJD9-3O0R-JG52|d2b2fd638ea46851d475920075957e01e8f372b1|lout">
...
WRM._unparsedData["jira.request.correlation-id"]="\"f539e7bded0940\"";
...
<li id="user-options">
            <a class="aui-nav-link login-link" href="/jira/login.jsp?os_destination=%2Fsecure%2Fattachment%2F19065%2FMQJ_290.py">Log In</a>
...
<div class="hidden"
    ...
    <input
        ...
        type="hidden"
            ...
            value="/secure/attachment/19065/MQJ_290.py"
...
<form id="jira_request_timing_info" class="dont-default-focus" >
	<fieldset class="parameters hidden">
		<input type="hidden" title="jira.request.start.millis" value="1507838306841" />
		<input type="hidden" title="jira.request.server.time" value="33" />
		<input type="hidden" title="jira.request.id" value="1018x445114x1" />
...
<!--
	                 REQUEST ID : 1018x445114x1
	          REQUEST TIMESTAMP : [12/Oct/2017:16:58:26 -0300]
	               REQUEST TIME : 0.0330
	                 ASESSIONID : -
	        CONCURRENT REQUESTS : 1

	                      db.conns : OpSnapshot{name='db.conns', invocationCount=1, elapsedTotal=179818, elapsedMin=179818, elapsedMax=179818, resultSetSize=0, cpuTotal=0, cpuMin=0, cpuMax=0}
-->
