...
<meta id="atlassian-token" name="atlassian-token" content="BUQO-ZJD9-3O0R-JG52|c84679daf99cfe6c9819b2f8d22719a71630b833|lout">
...
WRM._unparsedData["jira.request.correlation-id"]="\"873b5dc2427935\"";
...
<li id="user-options">
            <a class="aui-nav-link login-link" href="/jira/login.jsp?os_destination=%2Fsecure%2Fattachment%2F19066%2FMQJ_293.py">Log In</a>
...
<div class="hidden"
    ...
    <input
        ...
        type="hidden"
            ...
            value="/secure/attachment/19066/MQJ_293.py"
...
<form id="jira_request_timing_info" class="dont-default-focus" >
	<fieldset class="parameters hidden">
		...
		<input type="hidden" title="jira.request.id" value="1018x445113x1" />
...
<!--
	                 REQUEST ID : 1018x445113x1
	          REQUEST TIMESTAMP : [12/Oct/2017:16:58:26 -0300]
	               REQUEST TIME : 0.0350
	                 ASESSIONID : -
	        CONCURRENT REQUESTS : 2

	                      db.conns : OpSnapshot{name='db.conns', invocationCount=1, elapsedTotal=222166, elapsedMin=222166, elapsedMax=222166, resultSetSize=0, cpuTotal=0, cpuMin=0, cpuMax=0}
-->
