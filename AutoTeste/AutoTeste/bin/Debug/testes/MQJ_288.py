...
<meta id="atlassian-token" name="atlassian-token" content="BUQO-ZJD9-3O0R-JG52|a4a57bc68ccfc6231b4fa552587ddc63ecb73217|lout">
...
WRM._unparsedData["jira.request.correlation-id"]="\"e8acf17a3e4c09\"";
...
<li id="user-options">
            <a class="aui-nav-link login-link" href="/jira/login.jsp?os_destination=%2Fsecure%2Fattachment%2F19063%2FMQJ_288.py">Log In</a>
...
<div class="hidden"
    ...
    <input
        ...
        type="hidden"
            ...
            value="/secure/attachment/19063/MQJ_288.py"
...
<form id="jira_request_timing_info" class="dont-default-focus" >
	<fieldset class="parameters hidden">
		<input type="hidden" title="jira.request.start.millis" value="1507838306588" />
		<input type="hidden" title="jira.request.server.time" value="33" />
		<input type="hidden" title="jira.request.id" value="1018x445111x1" />
...
<!--
	                 REQUEST ID : 1018x445111x1
	          REQUEST TIMESTAMP : [12/Oct/2017:16:58:26 -0300]
	               REQUEST TIME : 0.0330
	                 ASESSIONID : -
	        CONCURRENT REQUESTS : 1

	                      db.conns : OpSnapshot{name='db.conns', invocationCount=1, elapsedTotal=163474, elapsedMin=163474, elapsedMax=163474, resultSetSize=0, cpuTotal=0, cpuMin=0, cpuMax=0}
-->
