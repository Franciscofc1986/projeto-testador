...
<meta id="atlassian-token" name="atlassian-token" content="BUQO-ZJD9-3O0R-JG52|82ffd4f0b872ad8b10b814ec7c48ac777f186f62|lout">
...
WRM._unparsedData["jira.request.correlation-id"]="\"8a62fbf0ba8659\"";
...
<li id="user-options">
            <a class="aui-nav-link login-link" href="/jira/login.jsp?os_destination=%2Fsecure%2Fattachment%2F19061%2FMQJ_289.py">Log In</a>
...
<div class="hidden"
    ...
    <input
        ...
        type="hidden"
            ...
            value="/secure/attachment/19061/MQJ_289.py"
...
<form id="jira_request_timing_info" class="dont-default-focus" >
	<fieldset class="parameters hidden">
		<input type="hidden" title="jira.request.start.millis" value="1507838306552" />
		<input type="hidden" title="jira.request.server.time" value="36" />
		<input type="hidden" title="jira.request.id" value="1018x445109x1" />
...
<!--
	                 REQUEST ID : 1018x445109x1
	          REQUEST TIMESTAMP : [12/Oct/2017:16:58:26 -0300]
	               REQUEST TIME : 0.0360
	                 ASESSIONID : -
	        CONCURRENT REQUESTS : 1

	                      db.conns : OpSnapshot{name='db.conns', invocationCount=1, elapsedTotal=136120, elapsedMin=136120, elapsedMax=136120, resultSetSize=0, cpuTotal=0, cpuMin=0, cpuMax=0}
-->
